  ...
  return (
    <div className='cipher__content'>
      <div className='cipher__content_about'>
        ...
        <textarea type='text' className='cipher__content_about-input' placeholder='Add something about you.'></textarea>
      </div>
      <div className='cipher__content-divider'></div>
      <div className='cipher__content_map'>
        <div className='cipher__content_map-title'>
          CIPHER MAP
        </div>
        ...
        <div className='cipher__content_socials__inputs'>
          <div className='cipher__content_socials__inputs_cards'>
            ...
            <div className='cipher__content_socials__inputs_cards-tab'>
              ...
              <input className='cipher__content_socials__inputs_cards-input' placeholder='LinkedIn' />
            </div>
          </div>
          <div className='cipher__content_socials__inputs_cards'>
            <div className='cipher__content_socials__inputs_cards-title'>
            ...
            <div className='cipher__content_socials__inputs_cards-tab'>
              ...
              <input className='cipher__content_socials__inputs_cards-input' placeholder='GitHub' />
            </div>
          </div>
          <div className='cipher__content_socials__inputs_cards'>
            <div className='cipher__content_socials__inputs_cards-title'>
            ...
            <div className='cipher__content_socials__inputs_cards-tab'>
              ...
              <input className='cipher__content_socials__inputs_cards-input' placeholder='Facebook' />
            </div>
          </div>
          <div className='cipher__content_socials__inputs_cards'>
            <div className='cipher__content_socials__inputs_cards-title'>
            ...
            <div className='cipher__content_socials__inputs_cards-tab'>
              ...
              <input className='cipher__content_socials__inputs_cards-input' placeholder='Twitter' />
            </div>
          </div>
          <div className='cipher__content_socials__inputs_cards'>
            <div className='cipher__content_socials__inputs_cards-title'>
            ...
            <div className='cipher__content_socials__inputs_cards-tab'>
              ...
              <input className='cipher__content_socials__inputs_cards-input' placeholder='Instagram' />
            </div>
          </div>
          <div className='cipher__content_socials__inputs_cards'>
            <div className='cipher__content_socials__inputs_cards-title'>
            ...
            <div className='cipher__content_socials__inputs_cards-tab'>
              ...
              <input className='cipher__content_socials__inputs_cards-input' placeholder='Your Website' />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className='cipher__content_socials__inputs cipher__content_info__inputs'>
          <div className='cipher__content_socials__inputs_cards cipher__content_info-inputs'>
            ...
            <div className='cipher__content_socials__inputs_cards-tab cipher__content_info-inputs_tab'>
              <input className='cipher__content_socials__inputs_cards-input' placeholder='Graduation' />
          ...
          <div className='cipher__content_socials__inputs_cards cipher__content_info-inputs'>
            ...
            <div className='cipher__content_socials__inputs_cards-tab cipher__content_info-inputs_tab'>
              <input className='cipher__content_socials__inputs_cards-input cipher__content_info-input' placeholder='College Student' />
              <i className="bi bi-chevron-down cipher__content_socials__inputs_cards-icon cipher__content_info-icon" />
            </div>
          </div>
        </div>
      ...
      <div className='cipher__content_password'>
        ...
        <input placeholder='*********' className='cipher__content_password-input'></input>
      </div>
      <div className='cipher__content-divider'></div>
