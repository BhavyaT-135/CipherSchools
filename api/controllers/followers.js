...
const getFollowers = async (req, res) => {
  ...
  try {
    ...
    console.error(error);
    res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({ message: 'Error retrieving followers' });
  }
}
...
const addFollowers = async (req, res) => {
  ...
  try {
    ...
    console.error(error);
    res.status(StatusCodes.INTERNAL_SERVER_ERROR).json({ message: 'Error adding follower' });
  }
}
